	...
	<div class="container">
	    <div class="row align-items-center my-5">
	        ...
	        <div class="col-md-12 col-lg-6 col-sm-12 mb-5">
	            ...
	            <p class="font-italic text-muted mb-0">Fill your Information here to sign in.</p>
	        </div>
	        ...
	        <div class="login-form">
	         ...
	         <form action="/login-validation" method="POST">
		        ...
		        <div class="form-group mt-3">
                    ...
                    <!-- CHANGE #2 → added hint text under email input -->
				...
				<div class="form-group mt-3">
                    ...
                    <!-- CHANGE #3 → added hint under password field -->
		            <small class="form-text text-muted">
		                user or 123
		            </small>
		        </div>    
