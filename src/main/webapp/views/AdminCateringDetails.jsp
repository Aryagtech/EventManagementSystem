                	 ...
                	 <c:forEach var="allcater" items="${caterlist}" >
			           ...
			           <td ><img src="data:image/jpeg;base64,${allcater.cater_img}" class="rounded-circle" width="100" height="100"/></td>
                        ...
                        <td class="d-flex">
                            ...
                            <a href="/admindeletecater/${allcater.id}" class="btn btn-danger ml-2" onclick='return deleteCatering()'>DELETE</a>
                        </td>
                        </tr>
                    </c:forEach>
                </tbody>
	...
	<script type="text/javascript">
        $(document).ready(function() {
            $('table .edit').click(function ()
            {
                ...
                $.ajax({
                    type: "GET",
                    url: "${pageContext.request.contextPath}/caterfind/"+id, //this is servlet
