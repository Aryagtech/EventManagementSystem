            ...
            <form action="/addhotelForm" modelAttribute="hotelForm" method="POST"  enctype= "multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="HotelName" name="hotelName" id="hotelName" required>
                    </div>
                    <div class="form-group">
                        <label for="message-text" class="col-form-label">Hotel Description</label>
						<textarea class="form-control" name="hotelDesc" placeholder="Hotel Description" id="HotelDescription"></textarea>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
						...
						<textarea class="form-control" name="location" placeholder="Hotel Location" id="Hotellocation"></textarea>
                    </div>
                </div>
